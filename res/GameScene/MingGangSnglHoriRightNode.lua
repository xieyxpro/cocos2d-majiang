...
Image_1:setPosition(-16.0036, 27.8261)
...
layout:setLeftMargin(-30.5036)
layout:setRightMargin(55.5036)
layout:setTopMargin(5.6739)
layout:setBottomMargin(13.3261)
...
txtNum:setPosition(-15.4981, 27.2880)
...
layout:setPositionPercentY(0.5685)
layout:setPercentWidth(0.1852)
layout:setPercentHeight(0.4167)
layout:setSize({width = 10.0000, height = 20.0000})
layout:setLeftMargin(-20.4981)
layout:setRightMargin(64.4981)
layout:setTopMargin(10.7120)
layout:setBottomMargin(17.2880)

...
GameDefine.DELEGATE_WAIT_TIME = 2 --托管模式下等待时间（单位：秒）
...
GameDefine.ROOM_TYPE_NORMAL = 1 
GameDefine.ROOM_TYPE_GOLD_MATCH = 2 

GameDefine.TIMER_ID_AUTO_ACTION = 1
GameDefine.TIMER_ID_SYS_DISPATCH_CARD = 2
